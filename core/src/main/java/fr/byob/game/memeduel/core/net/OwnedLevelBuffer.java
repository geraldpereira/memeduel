...
public class OwnedLevelBuffer extends ListQueryBuffer<Level> {

	private final String owner;

	public OwnedLevelBuffer(final String owner) {
		super(5);
		this.owner = owner;
	}
	...
	protected void queryList(final int limit, final int offset, final Callback<Level[]> callBack) {
		...
		dao.owned(user, owner, limit, offset, new Callback<String>() {
			@Override
